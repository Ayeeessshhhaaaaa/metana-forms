...
const countries = [
  ...
  { value: 'CD', label: 'Congo, Democratic Republic of the', code: '+243', flag: '🇨🇩' },
  ...
  { value: 'FK', label: 'Falkland Islands (Malvinas)', code: '+500', flag: '🇫🇰' },
  ...
  { value: 'TF', label: 'French Southern Territories', code: '+262', flag: '🇹🇫' },
  ...
  { value: 'VA', label: 'Holy See (Vatican City State)', code: '+379', flag: '🇻🇦' },
  ...
  { value: 'LA', label: 'Lao People\'s Democratic Republic', code: '+856', flag: '🇱🇦' },
  ...
  { value: 'MP', label: 'Northern Mariana Islands', code: '+1-670', flag: '🇲🇵' },
  ...
  { value: 'SH', label: 'Saint Helena, Ascension and Tristan da Cunha', code: '+290', flag: '🇸🇭' },
  { value: 'KN', label: 'Saint Kitts and Nevis', code: '+1-869', flag: '🇰🇳' },
  { value: 'LC', label: 'Saint Lucia', code: '+1-758', flag: '🇱🇨' },
  { value: 'MF', label: 'Saint Martin (French part)', code: '+590', flag: '🇲🇫' },
  { value: 'PM', label: 'Saint Pierre and Miquelon', code: '+508', flag: '🇵🇲' },
  { value: 'VC', label: 'Saint Vincent and the Grenadines', code: '+1-784', flag: '🇻🇨' },
  ...
  { value: 'SX', label: 'Sint Maarten (Dutch part)', code: '+1-721', flag: '🇸🇽' },
  ...
  { value: 'GS', label: 'South Georgia and the South Sandwich Islands', code: '+500', flag: '🇬🇸' },
  ...
  { value: 'TC', label: 'Turks and Caicos Islands', code: '+1-649', flag: '🇹🇨' },
...
const formatOptionLabel = ({ label, code, flag }) => (
  <div style={{ display: 'flex', alignItems: 'center' }}>
    ...
    <span>{label}</span>
    <span style={{ marginLeft: 'auto', paddingLeft: 10, color: '#6c757d' }}>{code}</span>
  </div>
);
  ...
  return (
    <div className='question'>
      <div className="question-title">
        <span>4<span className="material-symbols-outlined">arrow_right_alt</span></span>
